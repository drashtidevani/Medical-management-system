					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main"><h3>
								...
								<span class="kt-subheader__title"><h3><b><u>Surgeon Decline</u></b></h3></span>
							</div>
...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
	   ...
	   $con = mysqli_connect("localhost","root","","medical");
		$str = "select * from surgeonmaster where status='decline' ";
	...
	<?php											
						...
						echo "<td> <a href='surgeon_decline_approv.php?surgeonid=".$row['surgeonid']."'>Approve</a></td>";
						echo "</tr>";
					}
	?>
