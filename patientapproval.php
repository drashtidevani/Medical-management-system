					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main"><h3>
								...
								<span class="kt-subheader__title"><h3><b><u>Patient Approval</u></b></h3></span>
							</div>
                        ...
                        <div class="kt-portlet kt-portlet--mobile">
							...
							<?php
								...
								$str = "select * from patient where status='pending' ";
							...
							<?php											
												...
												echo "<td> <a href='approval1.php?patient_id=".$row['patient_id']."'>Approve</a></td>";
												echo "</tr>";
											}
							?>
