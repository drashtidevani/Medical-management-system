...
if(!empty($_POST['degree_name'])){
    ...
    {
        $query = "INSERT INTO `degree` (`degre_id`, `degree_name`, `status`) VALUES (NULL, '".$degree_name."', '".$status."');";
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-subheader__main"><h3>
                             <span class="kt-subheader__iconfa fa fa-graduation-cap"></span></h3>&nbsp;&nbsp;
                             <span class="kt-subheader__title"><h3><b><u>Degree</u></b></h3></span>
                        </div>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
								...
								<div class="kt-portlet__head-toolbar">
                                                <a href="viewdegree.php" class="btn btn-brand btn-elevate">
                                                    View Data
                                                </a>
                                </div>
                            </div>
                            ...
                            <form class="kt-form kt-form--label-right" method="post">
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="degree_name" placeholder="Degree Name"
                                                id="example-text-input" pattern="^[A-Za-z_.-]*$" minlength="2" maxlength="6" title="Please enter only alphabet" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label">
                                           <h5><b>Status</b></h5></label>
