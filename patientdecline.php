					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main"><h3>
								...
								<span class="kt-subheader__title"><h3><b><u>Patient Decline</u></b></h3></span>
							</div>
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <?php
							           $con = mysqli_connect("localhost","root","","medical");
										$str = "select * from patient where status='decline' ";
						            ...
						            <?php											
												...
												echo "<td> <a href='patient_decline_approve1.php?patient_id=".$row['patient_id']."'>Approve</a></td>";
												echo "</tr>";
											}
									?>
								</table>
