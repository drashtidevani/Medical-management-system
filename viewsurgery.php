                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-subheader__main"><h4>
						 <span class="kt-subheader__iconfa fa fa-file-signature"></span></h4>&nbsp;&nbsp;
						    <span class="kt-subheader__title"><h4><b><u>View Surgery</u></b></h4></span>
                        </div>
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $r['surgery_id']; ?></td>
                                            <td><?php echo $r['surgery_name']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                href="editSurgery.php?id=<?php echo $r['surgery_id']; ?>">
                                                    <i class="la la-edit"></i>
                                                </a>
                                                <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                    href="deleteSurgery.php?id=<?php echo $r['surgery_id']; ?>">
