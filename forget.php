...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>MedicalConsultation</title>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v4 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(./assets/media/bg/bg-66.jpg);">
						...
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h2 class="kt-login__title" style="font-size: 25px">Forget Password</h2>
									<p style="font-size: 15px" align="center">You can reset your password here.</p>
								</div>
								
								 
								
								<form class="kt-form" action="password-reset-token.php" method="post">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Email Address" name="email" autocomplete="off">
									</div>
																		
									<div class="kt-login__actions">
										<button id="kt_login_signin_submit" type="submit" class="btn btn-brand btn-pill kt-login__btn-primary">Send</button>
									</div>
								</form>
							</div>
