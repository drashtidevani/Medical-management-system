...
if(!empty($_POST['surgery_name'])){
	...
	$query = "UPDATE `surgery` SET `surgery_name` = '".$surgery_name."', `status` = '".$status."' WHERE `surgery_id` = ".$surgery_id;
...
if(!empty($_GET['id'])){
    $id=$_GET['id'];
    $query = "SELECT * FROM `surgery` WHERE surgery_id=".$id;
	$result= $mysqli->query($query);
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-toolbar"><h4>
                                    ...
                                    <span class="kt-portlet__head-title"><h4><b><u>Edit Surgery</u></b></h4></span>
                                </div>
                            </div>
                            <!--begin::Form-->
                            ...
                            <form class="kt-form kt-form--label-right" method="post">
                                <div class="kt-portlet__body">
                                    <input type="hidden" name="surgery_id" value="<?php echo $row['surgery_id']; ?>">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label"><h5><b>Surgery Name</b></h5></label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="surgery_name" value="<?php echo $row['surgery_name']; ?>"  pattern="^[A-Za-z_.-]*$"    minlength="2" maxlength="20" title="Please enter only alphabet" placeholder="Surgery Name" id="example-text-input" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <?php } else { ?>
                                <form class="kt-form kt-form--label-right" method="post">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Surgery Name</label>
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="Surgery_name" placeholder="Surgery Name"
                                                    id="example-text-input"  pattern="^[A-Za-z_.-]*$"    minlength="2" maxlength="20" title="Please enter only alphabet" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">
