...
if(!empty($_POST['package_name']))
{
    ...
    {
        $query ="INSERT INTO `package` (`package_id`, `package_name`, `duration`, `amount`, `status`) VALUES (NULL, '".$package_name."','".$duration."','".$amount."',   '".$status."');";
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                    <div class="kt-subheader__main"><h3>
					 <span class="kt-subheader__iconfa fa fa-gift"></span></h3>&nbsp;&nbsp;
                        <span class="kt-subheader__title"><h3><b>package</b></h3></span>
                    </div>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                                            ...
                                            <div class="kt-portlet__head-toolbar">
                                                <a href="viewpackage.php" class="btn btn-brand btn-elevate">
                                                    View Data
                                                </a>
                                            </div>
                        </div>
                        ...
                        <form class="kt-form kt-form--label-right" method="post">
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" name="package_name" placeholder="Package" id="example-text-input" pattern="^[A-Za-z_.-]*$" minlength="2" maxlength="15" title="Please enter only alphabet" required>
                                    </div>
                                </div>  
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label"><h5><b>Duration(month)</b></h5></label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" name="duration" placeholder="Duration" id="example-text-input" pattern="[1-9]{1,}" required>
                                    </div>
                                </div> 
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <input type="number" class="form-control kt-selectpicker" name="amount"  min="0" max="10000" required>
                                    </div>
                                </div>
