...
<?php 
	$query = "SELECT * FROM `hospital` join `city` on hospital.city_id = city.city_id ";
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main"><h4>
							 <span class="kt-subheader__iconfa fa fa-file-signature"></span></h4>&nbsp;&nbsp;
								<span class="kt-subheader__title"><h4><b><u>View Hospital</u></b></h4></span>
							</div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                href="edithospital.php?id=<?php echo $r['hospital_id']; ?>">
                                                    <i class="la la-edit"></i>
                                                </a>
                                                <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                    href="deletehospital.php?id=<?php echo $r['hospital_id']; ?>">
