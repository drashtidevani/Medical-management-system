            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                    <div class="kt-subheader__main"><h4>
					   <span class="kt-subheader__icon fa fa fa-file-signature"></span></h4>&nbsp;&nbsp;
					   <span class="kt-subheader__title"><h4><b><u>View Degree</u></b></h4></span>
                    </div>
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        ...
                                        &nbsp;
                                        <a href="DoctorsDegreeAdd.php" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $r['degre_id']; ?></td>
                                        <td><?php echo $r['degree_name']; ?></td>
                                        ...
                                        <td>
                                            ...
                                            href="editDegree.php?id=<?php echo $r['degre_id']; ?>">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                href="deleteDegree.php?id=<?php echo $r['degre_id']; ?>">
