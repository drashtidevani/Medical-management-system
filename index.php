...
if(!empty($_POST['email'])){
	...
	if(empty($row['admin_id'])){
		$_SESSION["error"] = "User Not Exist Please Check Email address.";
	}else{
		if($row['password'] !== $password){
			$_SESSION["error"] = "User and password are not match.";
		}else{
			$_SESSION['user'] = $row;
			redirect("home.php");
		}
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
									<img src="./assets/media/logos/footer-logo.png" >
							</div>
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h2 class="kt-login__title" style="font-size: 25px">Sign In To Admin</h2>
								</div>
